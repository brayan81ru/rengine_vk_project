...
namespace REngine {
    ...
    bool DisplayManager::ApplyDisplayMode(SDL_Window* window, VulkanRenderer* renderer, const DisplayMode& mode, const FullScreenMode &fullScreenMode) {
        ...
        const auto res = SDL_SetWindowFullscreen(window, flags);
